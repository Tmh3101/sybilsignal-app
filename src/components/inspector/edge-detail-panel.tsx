...
import { RELATION_COLORS, LIGHT_RELATION_COLORS } from "@/lib/graph-constants";
    ...
    <div className="flex h-full flex-col overflow-hidden border-l border-slate-200 bg-white font-mono shadow-2xl dark:border-slate-800/80 dark:bg-[#050810]">
      ...
      <div className="flex flex-shrink-0 items-center justify-between border-b border-slate-100 px-4 py-4 dark:border-slate-800/80">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] text-slate-400 uppercase dark:text-slate-500">
      ...
      <div className="scrollbar-thin flex-1 overflow-y-auto p-4">
        ...
        <div className="mb-6 flex flex-col gap-3">
          <div className="flex flex-col gap-1 border border-slate-100 bg-slate-50 p-3 dark:border-slate-800/50 dark:bg-slate-900/20">
            <span className="text-[8px] font-bold tracking-widest text-slate-400 uppercase dark:text-slate-500">
              {t("source_label")}
            </span>
            <span className="text-[10px] break-all text-slate-700 dark:text-slate-300">
              {sourceId}
            </span>
          </div>
        ...
        {type === "SIMILARITY" && (
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-bold tracking-widest text-slate-500 uppercase dark:text-slate-400">
            ...
            {violations.length > 0 ? (
              <div className="flex flex-col gap-1.5">
                ...
                <div className="mt-2 border-t border-slate-100 pt-2 dark:border-slate-800">
                  <p className="text-[8px] leading-relaxed text-slate-400 uppercase italic dark:text-slate-500">
                    {t("similarity_constraints_info")}
                  </p>
                </div>
              </div>
            ) : (
              <div className="border border-slate-100 bg-slate-50 px-3 py-4 text-center dark:border-slate-800 dark:bg-slate-900/20">
                <span className="text-[9px] text-slate-400 uppercase italic dark:text-slate-600">
        ...
        {type !== "SIMILARITY" && (
          <div className="border border-slate-100 bg-slate-50 p-4 text-center dark:border-slate-800 dark:bg-slate-900/20">
            <p className="text-[9px] leading-relaxed text-slate-400 uppercase dark:text-slate-500">
      ...
      <div className="border-t border-slate-100 px-4 py-3 dark:border-slate-800/60">
        <div className="flex items-center justify-between">
          <span className="text-[8px] font-bold tracking-widest text-slate-400 uppercase italic dark:text-slate-600">
            {t("logic_info")}
          </span>
